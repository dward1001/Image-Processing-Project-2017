...
void CColorConversionView::OnProblem1Sub1()
{
	...
	for(r=0; r<height; r++){
		for(c=0; c<width; c++){
			mg_lpImage[r*width + c] = m_dibFile.m_lpImage[r*width + c]/2;
		}
	}
	///////////////////////////////////////////////////////
...
void CColorConversionView::OnProblem1Sub2()
{
	...
	for(r=0; r<height; r++){
		for(c=0; c<width; c++){
			g = m_dibFile.m_lpImage[r*width + c]*2 > 255 ? 255 : m_dibFile.m_lpImage[r*width + c]*2;
			mg_lpImage[r*width + c] = g;
		}
	}
	///////////////////////////////////////////////////////
...
void CColorConversionView::OnProblem2()
{
	...
	for(r=0; r<height; r++){
		for(c=0; c<width; c++){
			rd = m_dibFile.m_lpImage[(r*width + c)*3+2];
			gr = m_dibFile.m_lpImage[(r*width + c)*3+1];
			bl = m_dibFile.m_lpImage[(r*width + c)*3];
			mg_lpImage[r*width + c] = 0.299*rd + 0.587*gr + 0.114*bl;
		}
	}
	///////////////////////////////////////////////////////
...
void CColorConversionView::OnProblem3()
{
	...
	for(r=0; r<height; r++){
		for(c=0; c<width; c++){
			bl = ((tempim16[r*width+c] & 31))*255/31;
			gr = (((tempim16[r*width+c] >> 5) & 31))*255/31;
			rd = (((tempim16[r*width+c] >> 10) & 31))*255/31;
			mg_lpImage[r*width + c] = 0.299*rd + 0.587*gr + 0.114*bl;
		}
	}
