...
int _tmain(int argc, _TCHAR* argv[])
{
		...
		addWeighted(img1_Mat,alpha,NULL,beta,0,img1_Mat_half);
		...
		addWeighted(img1_Mat,alpha,NULL,beta,0,img1_Mat_double);
		...
		Mat img2_Mat_Gray;
		cvtColor(img2_Mat,img2_Mat_Gray,CV_BGR2GRAY);
		...
		Mat img3_Mat_Gray;
		cvtColor(img3_Mat,img3_Mat_Gray,CV_BGR2GRAY);
